...
public class InfoAdapter extends BaseAdapter{
	...
	public InfoAdapter(Context context,ArrayList<Map<String, Object>> mlistHashMaps) {
	...
	public View getView(final int arg0, View convertView, ViewGroup arg2) {
		...
		if (convertView !=null) {
			...
			convertView = LayoutInflater.from(mContext).inflate(R.layout.info_item, arg2, false);
