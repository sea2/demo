...
public class SearchPeopleAdapter extends BaseAdapter{
	...
	public SearchPeopleAdapter(Context context,ArrayList<Map <String, Object>> mlistHashMaps) {
	...
	public View getView(final int arg0, View convertView, ViewGroup arg2) {
		...
		if (convertView !=null) {
			...
			convertView = LayoutInflater.from(mContext).inflate(R.layout.item_people_search, arg2, false);
